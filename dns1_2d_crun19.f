...
!================================================
!     TODO: TRANSFORM CHGT VARIABLE VERS CARTESIEN
!================================================
! En attendant:
      z(1)=1
      do i=1,nx
...
!      write(*,*) 'Z',z(1)
!================================================
!     STOCKAGE CHAMPS INST FICHIER NETCDF
!================================================
      ipasPIV=500
...
! mise en forme pour subroutine netcdf
        do i=1,nx
           do j=1,ny              
                 unc(i,j,1,1)=u(i,j,ianc)
                 vnc(i,j,1,1)=v(i,j,ianc)
                 wnc(i,j,1,1)=1
!                 write(*,*) 'wnc(',i,',',j,')=',wnc(i,j,1,1)
           enddo
        enddo
        ...
        call Write_Ncdf(pathresults,fileout,nx,ny,1,x,y,z,unc,vnc,wnc)
      endif
!================================================
...
!================================================
!   AUTRE CRITERE ARRET BOUCLE CONTROLE: LF 
!================================================
! ACCU Um
           do i=1,nx
              do j=1,ny
