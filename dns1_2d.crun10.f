...
!-> CARO
      xite=float(ite)*past
      write(200,*) xite,dyu(int(30.D0/pasx),1,iact)
...
!
      ...
      nu5=5*nx/6
      xite=float(ite)*past
      write(92,108)xite,u(nu1,2,iact),u(nu1,5,iact),
     &u(nu1,10,iact),u(nu1,15,iact)
      write(93,108)xite,u(nu2,2,iact),u(nu2,5,iact),
     &u(nu2,10,iact),u(nu2,15,iact)
      write(94,108)xite,u(nu3,2,iact),u(nu3,5,iact),
     &u(nu3,10,iact),u(nu3,15,iact)
      write(95,108)xite,u(nu4,2,iact),u(nu4,5,iact),
     &u(nu4,10,iact),u(nu4,15,iact)
      write(96,108)xite,u(nu5,2,iact),u(nu5,5,iact),
     &u(nu5,10,iact),u(nu5,15,iact)
 108  format(5e23.14)
!
...
!
           do i=1,nx
              do j=1,ny
                 ...
                 vmean(i,j)=umean(i,j)/float(nitef)
                 write(400,'(2es17.8)')umean(i,j),vmean(i,j)
              enddo
              write(400,*)
           enddo
