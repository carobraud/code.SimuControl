...
!================================================
           do i=1,nx
              do j=1,ny
c                 uinst(i,j)=u(i,j,ianc)
c                 vinst(i,j)=v(i,j,ianc)
...
c              call stockage(uinst,xmesh,ymesh,nx,ny,ite,past,'u') !range (-0.2:1.2)
c              call stockage(vinst,xmesh,ymesh,nx,ny,ite,past,'v') !range (-0.06:0.01)
...
!!!!!! USING |tauu|mean (research of first and second minimum) --> TODO: research minimum global
!        do i=nvit+12,nx-10
